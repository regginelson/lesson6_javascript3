...
function previewFive() {
   //locate first element where the tag is artticle assign to a variable
   ...
   //add apporpriate src values to two new img elements
...
//declare vairable for the document element with id of leftarrow, which is in the html document var leftarrow, which is in the html document
